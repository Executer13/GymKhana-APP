...
import 'package:testing/CartPage.dart';
import 'package:testing/cast_vote.dart';
...
fkface() async {
await facehanlder().handle('text');
}


class BottomNavBarV2 extends StatefulWidget {
    final List<CameraDescription> cameras;
      const BottomNavBarV2( this.cameras);
  @override
...
FirebaseMessaging.instance
 ...
 //big whit circle
  ...
  Widget build(BuildContext context) {
    ...
    MyFPage(),
    ProfilePage() ,
    MyFacePage(this.widget.cameras),
    Notifications(),
    ...
    return WillPopScope(onWillPop:  () => Future.value(false),
      child: Scaffold(
        body: SingleChildScrollView(child: _pages[currentIndex]),
